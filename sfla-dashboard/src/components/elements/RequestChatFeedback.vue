...
<template>
<div :id='id'>
    <button type='button' class='button-toolbar button-secondary' :id='id + "-button"' @blur="closeFeedback" @click='openFeedback(); requestFeedback()' aria-label="request feedback" data-bs-toggle="tooltip" title="Feedback">
